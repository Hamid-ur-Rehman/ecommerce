...
export class BasicSeedData1700000000002 implements MigrationInterface {
  name = 'BasicSeedData1700000000002';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // Check if roles already have data
    ...
    // Check if products already have data
