...
export declare class CategoriesController {
    ...
    findTree(): Promise<import("./entities/category.entity").Category[]>;
    getActive(): Promise<import("./entities/category.entity").Category[]>;
    findOne(id: string): Promise<import("./entities/category.entity").Category>;
    getWithProducts(id: string): Promise<import("./entities/category.entity").Category>;
