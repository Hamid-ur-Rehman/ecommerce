...
class DatabaseSeeder {
    ...
    async seedRoles() {
        ...
        const roles = [
            ...
            {
                name: role_entity_1.RoleName.MODERATOR,
    ...
    async seedUsers() {
        ...
        const roleRepository = this.dataSource.getRepository(role_entity_1.Role);
        const adminRole = await roleRepository.findOne({ where: { name: role_entity_1.RoleName.ADMIN } });
        const userRole = await roleRepository.findOne({ where: { name: role_entity_1.RoleName.USER } });
        const users = [
            {
